                                            ...
                                            <Grid container spacing={2} sx={{ marginTop: "2%", marginBottom: "4%" }}>
                                                <Grid item xs={2}>
                                                    ...
                                                    <FormControl fullWidth>
                                                        ...
                                                        >
                                                            <MenuItem value={10}>Department</MenuItem>
                                                            <MenuItem value={20}>Government Organisation</MenuItem>
                                                ...
                                                <Grid item xs={5}>
                                                    ...
                                                    <FormControl fullWidth>
                                                        <TextField id="outlined-basic" label="Department / Government Organisation" variant="outlined" />
                                                    </FormControl>
                                                </Grid>
                                                <Grid item xs={5}>
                                                    <label>Office</label>
                                                    <FormControl fullWidth>
                                                        <TextField id="outlined-basic" label="Office" variant="outlined" />
                                                    </FormControl>
                                                </Grid>
